...
class Object
{
    ...
    {
        return Storage::instance()->save($this, $options, FALSE);
    }

    public function update(array $options = array())
    {
        return Storage::instance()->save($this, $options, TRUE);
    }
    ...
    {
        return Storage::instance()->deleteByQuery($this, $query, $safe);
    }
